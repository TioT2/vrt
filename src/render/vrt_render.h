  ...
  namespace render
  {
    namespace core
    {
      ...
      struct primitive
      {
        ...
        buffer ASStorageBuffer;
        VkAccelerationStructureKHR AS = VK_NULL_HANDLE;
      }; /* primitive */

      struct polygonal_primitive : primitive
      {
        buffer VertexBuffer {};
      ...
      public:
        ...
        polygonal_primitive Primitive;

        buffer SBTStorageBuffer;
        SIZE_T SBTAlignedGroupSize = 0;

        template <typename vertex_type>
          polygonal_primitive CreatePolygonalPrimitive( std::span<const vertex_type> Vertices, SIZE_T PositionComponentOffset, std::span<const UINT32> Indices, const mat4 &TransformMatrix = mat4() )
          {
            polygonal_primitive Primitive;
            ...
            Primitive.ASStorageBuffer = CreateBuffer(BuildSizesInfo.accelerationStructureSize, VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT | VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
            ...
            VkAccelerationStructureCreateInfoKHR AccelerationStructureCreateInfo
            {
              ...
              /* VkBuffer                              */ .buffer = Primitive.ASStorageBuffer.Buffer,
            ...
            vkCreateAccelerationStructureKHR(Device, &AccelerationStructureCreateInfo, nullptr, &Primitive.AS);

            GeometryBuildInfo.dstAccelerationStructure = Primitive.AS;
            ...
            return Primitive;
          } /* CreatePolygonalPrimitive */

        VOID Destroy( polygonal_primitive &Primitive )
        {
          vkDestroyAccelerationStructureKHR(Device, Primitive.AS, nullptr);
          Destroy(Primitive.ASStorageBuffer);
          Destroy(Primitive.VertexBuffer);
          if (Primitive.IndexCount != 0)
            Destroy(Primitive.IndexBuffer);
        } /* Destroy */
        ...
        VOID TestInitTLAS( VOID )
        {
          VkAccelerationStructureDeviceAddressInfoKHR DeviceAddressInfo
          {
            ...
            .pNext = nullptr,
            .accelerationStructure = Primitive.AS,
          };
        ...
        VOID Initialize( SDL_Window *RenderWindow )
        {
          ...
          Primitive = CreatePolygonalPrimitive<vec3>(Vtx, 0, Idx);
          TestInitTLAS();
          TestInitPipeline();
